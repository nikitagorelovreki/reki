  ...
  projects: [
    {
      ...
      setupFilesAfterEnv: ['<rootDir>/jest.setup.js', '<rootDir>/jest.backend.setup.js'],
      testEnvironment: 'node',
    },
    {
    ...
    },
    {
      ...
      testMatch: ['<rootDir>/packages/app-control-panel/tests/ui/**/*.test.tsx'],
      setupFilesAfterEnv: ['<rootDir>/jest.setup.js', '<rootDir>/jest.ui.setup.js'],
